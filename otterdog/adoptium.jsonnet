...
orgs.newOrg('adoptium', 'adoptium') {
  ...
  _repositories+:: [
    ...
    newAQAvitRepo('aqa-triage-data') {
      allow_merge_commit: true,
      allow_update_branch: false,
      delete_branch_on_merge: false,
      dependabot_security_updates_enabled: true,
      description: "Repository for storing AQAvit Triage data generated by and for use from aqa-test-tools",
      has_issues: false,
    },
    ...
    newMirrorRepo('jdk24u') {},
    newMirrorRepo('jdk25u') {},
    newMirrorRepo('jdk26u') {},
    newMirrorRepo('jdk27u') {},
    newMirrorRepo('jdk8u') {},
